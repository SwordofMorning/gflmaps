...
const loadData = async () => {
  ...
  const loaders = {
    ...
    "UI_TEXT": loadJsonFile(`./text/${config.langCode}/ui_text.json?v=1789442974`).then((result) => UI_TEXT = result),
    ...
    "INSTRUCTIONS": loadTextFile(`./text/${config.langCode}/instructions.html?v=1789442974`).then((result) => INSTRUCTIONS = result),
