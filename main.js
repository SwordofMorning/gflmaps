...
const loadData = async () => {
  ...
  const loaders = {
    ...
    "UI_TEXT": loadJsonFile(`./text/${config.langCode}/ui_text.json?v=1789182760`).then((result) => UI_TEXT = result),
    ...
    "INSTRUCTIONS": loadTextFile(`./text/${config.langCode}/instructions.html?v=1789182760`).then((result) => INSTRUCTIONS = result),
